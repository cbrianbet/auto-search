<template>
  <div id="invoice-app">
    ...
    <table class="responsive-table">
      ...
      <tr v-for="(item, index) in items">
        ...
        <td data-label="Price/unite">
          <div class="cell-with-input">{{ invoiceCurrency.symbol }} <input type="number" min="0" v-model="item.price"/>
          </div>
        </td>
        ...
        <td class="text-right">
          <button class="is-danger" v-on:click="deleteItem(index)">Delete item</button>
        </td>
      </tr>
    </table>
    ...
    <table>
      ...
      <tr>
        <td>
          <div class="cell-with-input">Discount <input class="text-right" type="number" min="0" max="100"
      ...
      <tr>
        <td>
          <div class="cell-with-input">Tax <input class="text-right" type="number" min="0" max="100" v-model="taxRate"/>%
          </div>
        </td>
